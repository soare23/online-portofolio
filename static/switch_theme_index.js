...
let teamProjectHeader = document.getElementById('team-projects-header');
let projectsContainer = document.getElementById('projects-about');
let teamProjectsContainer = document.getElementById('team-projects-about');
...
function changeTheme() {
  if (localStorage.getItem('theme') == 'dark') {
    ...
    teamProjectHeader.style.color = '#5bc0de';
    projectsContainer.style.color = '#5bc0de';
    teamProjectsContainer.style.color = '#5bc0de';
    ...
    teamProjectHeader.style.color = 'white';
    projectsContainer.style.color = 'white';
    teamProjectsContainer.style.color = 'white';
